                  ...
                  return (
                    <>
                      <Tr>
                        ...
                        <Td>
                          <Link to={`${item._id}/detailVehicle/list`}>
                            <Text
                              as="button"
                              color="green.500"
                              fontWeight="normal"
...
export default function ListSelfVehicleAdmin() {
  ...
  const { data } = useSWR(
    [`https://pbl6-travelapp.herokuapp.com/selfVehicle/${userId}`, token],
    fetcher,
      ...
      <Box ml={{ base: 0, md: 60 }} transition=".3s ease">
        ...
        <Box as="main" p="4">
          <Heading size="lg" mb="10px">
            Danh sách dịch vụ cho thuê xe tự lái
          </Heading>
